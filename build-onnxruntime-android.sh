...
--android --android_sdk_path /data/qci/apps/android-sdk-linux \
--android_ndk_path /data/qci/apps/ndk/android-ndk-r20b \
--android_abi $2 \
--android_api $3 \
--target install
}

echo "请选择编译选项并回车: 1)Release，2)Debug. 3)MinSizeRel"
echo "Please Select Build Type: 1)Release，2)Debug. 3)MinSizeRel"
read -p "" BUILD_TYPE
if [ $BUILD_TYPE == 0 ]; then
    ...
    cmakeParams "MinSizeRel" "armeabi-v7a" 19
    cmakeParams "MinSizeRel" "arm64-v8a" 21
    cmakeParams "MinSizeRel" "x86" 19
    cmakeParams "MinSizeRel" "x86_64" 21
else
